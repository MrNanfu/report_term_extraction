...
#物理性质
word_probbingliwuli = {"无病变": 0.01,"囊性":0.01,"实性":0.01,"混合":0.01,"混合性":0.01,"囊实":0.01, "实质性":0.01, "类实性":0.01}
...
word_probbingliwulinangxing = {"导管扩张症":0.01,"积乳囊肿":0.01,"囊肿性病变":0.01,"纤维囊性变":0.01,"纤维囊性乳腺病":0.01,"囊肿": 0.01, "表皮样囊肿": 0.01, "皮样囊肿": 0.01, "皮脂腺囊肿": 0.01, "滑膜囊肿": 0.01, "粘液囊肿": 0.01,
                               "甲状舌管囊肿": 0.01, "间皮囊肿": 0.01, "腱鞘囊肿": 0.01, "毛根鞘囊肿": 0.01, "外毛根鞘囊肿": 0.01, "毛鞘囊肿": 0.01,
                               "毛囊源性囊肿": 0.01, "气管源性良性囊肿": 0.01, "鳃裂囊肿": 0.01}
word_probbingli_other = {"细胞":0.01,"导管":0.01,"腺体":0.01}
...
word_probexing_major={"浸润性小叶癌":0.01,"浸润性导管癌":0.01,"浸润性癌":0.01, "浸润癌":0.01, "浸润性乳腺癌":0.01,"导管原位癌":0.01,"原位癌":0.01,"恶性叶状肿瘤":0.01,"包裹性乳头状癌":0.01,"实性乳头状癌":0.01,"导管内乳头状癌":0.01, "化生性癌":0.01}
word_probliang_or_e_major={"非典型小叶增生":0.01,"导管内瘤":0.01, "肿瘤病变":0.01, "导管内乳头状病变":0.01, "纤维上皮性病变":0.01, "肿瘤性病变":0.01,"导管内乳头状肿瘤":0.01,"叶状肿瘤":0.01,"放射状瘢痕〈B3,不确定的潜在恶性病变）":0.01,"非典型导管增生":0.01,"非典型导管上皮增生":0.01, "导管上皮不典型增生":0.01, "导管上皮非典型增生":0.01, "平坦型上皮非典型增生":0.01,"平坦上皮非典型性":0.01,"导管上皮轻度非典型增生":0.01,"不典型增生":0.01,"导管上皮增生活跃":0.01, "非典型增生":0.01, "不典型导管增生":0.01, "导管上皮增生":0.01,"导管上皮增生稍活跃(B3,不确定的潜在恶性病变）":0.01,"上皮源性肿瘤":0.01}
word_probliangxing_major={"肉芽肿性乳腺炎":0.01,"泌乳腺瘤":0.01,"化脓性乳腺炎":0.01,"普通型增生":0.01, "肉芽肿":0.01,"肉芽肿性炎":0.01, "硬化性腺病":0.01, "错构瘤":0.01, "导管内乳头状瘤":0.01,"导管乳头状瘤":0.01, "导管内乳头状瘤炎性病变":0.01,"炎性":0.01,"炎症性改变":0.01,"炎症性":0.01,"炎症改变":0.01,"小叶性肉芽肿性乳腺炎":0.01,"小叶肉芽肿性乳腺炎":0.01,"肉芽肿性小叶炎":0.01,"肉芽肿性小叶性乳腺炎":0.01,"非特异性炎症性病变纤维上皮肿瘤":0.01, "梭形细胞病变":0.01, "非特异性炎症性病变":0.01, "纤维上皮性":0.01, "纤维上皮性肿瘤":0.01,"良性纤维上皮性肿瘤":0.01,"纤维腺瘤样增生":0.01,"纤维腺瘤":0.01,"纤维腺瘤改变":0.01,"幼年型纤维腺瘤":0.01,"良性叶状肿瘤":0.01,"泌乳性腺瘤":0.01,"管状腺瘤":0.01,"结节性泌乳性增生硬化性腺病":0.01, "结节性泌乳性增生":0.01, "错构瘤硬化性腺病":0.01, "复杂硬化性":0.01, "复杂性硬化性":0.01, "复杂硬化性病变":0.01, "表皮样囊肿":0.01, "复杂性硬化性病表皮样囊肿":0.01,"纤维囊性乳腺病":0.01,"纤维囊性变":0.01,"囊肿性病变":0.01, "积乳囊肿":0.01, "囊肿":0.01,"导管扩张症新辅助治疗后改变":0.01,"化疗后改变":0.01,"未见确切恶性肿瘤细胞":0.01,"未见肿瘤":0.011}
...
word_probbinglibingli={**word_probexing, **word_probliang_or_e,**word_probliangxing, **word_probjiaojie}
...
def pathologicalfuc(pathological_bodypart, pathological_report):#给parse输入的四个参数里的前两个有关病理的参数赋值给该函数
    ...
    word_prob_negative_word_all={'有无': 0.01,'不排除':0.01,'排除':0.01,'鉴别':0.01,'不完全除外':0.01,'不能除外':0.01,'不除外':0.01,'除外':0.01,'未见': 0.01}
    ...
    segmentsb_wuxiao_word = findsegments(input_str, word_prob_invalid)
    ...
    segmentsb_semicolon = findsegments(input_str, word_prob_semicolon)
    segmentsb_sep = findsegments(input_str, word_prob_sep)
    ...
    segmentsb5new = []
    interval_negative = []
    for k in range(int(len(segmentsb_negative_word_all) / 2)):
        if len(segmentsb_negative_word_all_copy)!=0:
            loc_comma = 0
            loc_full_stop = 0
            loc_negative_word=segmentsb_negative_word_all_copy[2 * k + 1]
            for i in range(int(len(segmentsb_sep)/2)):
                if segmentsb_sep[2*i+1]>loc_negative_word:
                    loc_full_stop=segmentsb_sep[2*i+1]
                    break
            # print('句号位置为')
            # print(loc_full_stop)
    ...
    if len(segmentsb_negative_word_all) != 0:
        ...
        if int(len(segmentsb_sep) / 2) == 1:
            ...
            if len(segmentsb_wuxiao_word) != 0:
                # 先按只有一个切缘来处理
                loc_wuxiao_word = segmentsb_wuxiao_word[1]
                for i in range(int(len(segmentsb_sep) / 2)):
                    if segmentsb_sep[2 * i + 1] > loc_wuxiao_word:
                        loc_full_stop2 = segmentsb_sep[2 * i + 1]
                        if 2 * i - 1 < 0:
                            loc_full_stop1 = 1
                        else:
                            loc_full_stop1 = segmentsb_sep[2 * i - 1]
                        break
        segmentsb5new = []
        for i in range(int(len(segmentsb5) / 2)):
            if segmentsb5[2 * i + 1] < loc_full_stop1 or segmentsb5[2 * i + 1] > loc_full_stop2:
                segmentsb5new.append(segmentsb5[2 * i])
                segmentsb5new.append(segmentsb5[2 * i + 1])
        segmentsb5 = segmentsb5new

        segmentsb3new = []
        for i in range(int(len(segmentsb3_raw) / 2)):
            if segmentsb3_raw[2 * i + 1] < loc_full_stop1 or segmentsb3_raw[2 * i + 1] > loc_full_stop2:
                segmentsb3new.append(segmentsb3_raw[2 * i])
                segmentsb3new.append(segmentsb3_raw[2 * i + 1])
        segmentsb3_raw = segmentsb3new
        ## 良恶性也要依据否定词进行修改
    ...
    for ibgy5 in range(len(segmentsb5)):
        ...
        if segmentsb5[ibgy5] in word_probb5daoguan.keys():
            segmentsb5[ibgy5] = '导管内瘤'
