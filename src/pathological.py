...
word_probexing_major={"浸润性乳头状癌":0.01,"浸润性小叶癌":0.01,"浸润性导管癌":0.01,"浸润性癌":0.01, "浸润癌":0.01, "浸润性乳腺癌":0.01,"导管原位癌":0.01,"原位癌":0.01,"恶性叶状肿瘤":0.01,"包裹性乳头状癌":0.01,"实性乳头状癌":0.01,"导管内乳头状癌":0.01, "化生性癌":0.01}
...
def pathologicalfuc(pathological_bodypart, pathological_report):#给parse输入的四个参数里的前两个有关病理的参数赋值给该函数
    ...
    for ibgy5 in range(len(segmentsb5)):
        ...
        if segmentsb5[ibgy5] in word_probb5xianbing.keys():
            segmentsb5[ibgy5] = '腺病'
